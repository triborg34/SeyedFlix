...
import 'package:seyedbox/widgets/CollapseWidget.dart';
        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
                ...
                child: ListTile(
                  style: ListTileStyle.list,
                  trailing: Icon(Icons.exit_to_app,color: white,),
